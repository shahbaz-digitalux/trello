        ...
        <>
            {board && <div>
                ...
                <div className="px-[32px] select-none">
                    <div className="flex py-[32px] justify-between pt-[76px] items-center">
                        <div className="flex space-x-6 text-[#172b4d] items-center">
                            <div
                                onClick={() => window.location = "/b/" + board._id}
                                title={board.title}
                                style={{background: board.bg}} className=" min-w-[60px] rounded-[4px]">
                                <p className="font-[900] text-5xl pb-1 px-2 text-center text-white cursor-pointer">
                                    {map(board.title.split(" "), title => {
                            ...
                            <div>
                                {editBoardName ?
                                    <div className="flex ">
                                        <input ref={boardName}
                                               className="outline-0 text-[14px] px-[12px] shadow-[inset_0_0_0_2px_#0079bf] rounded-[3px]"
                                               type="text" required defaultValue={board.title}
                                               placeholder="Enter Board Name"/>
                                        <div className="ml-6 flex items-center space-x-2">
                                            <button
                                                onClick={(e) => {
                                                    const bName = boardName.current.value;
                                                    if (bName.trim().length !== 0) {
                                                        dispatch(updateBoard({...board, "title": bName}));
                                            ...
                                            <button
                                                onClick={(e) => setEditBoardName(false)}
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <span
                                            ...
                                            className="hover:bg-[#091e4214] hover:cursor-pointer mt-[4px] ml-1 text-[12px] p-[4px] rounded-[3px] fa fa-pen ">
                                    </span>
                                    </div>
                                }
